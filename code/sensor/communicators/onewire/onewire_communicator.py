...
class OneWireCommunicator(CommunicatorAdapter, RaspberryPiCommunicator):
    ## Statics
    ...
    def initialize_communicator_raspberrypi(self):
        ...
        def validate_onewire_device_path(onewire_device_path: Path) -> bool:
        ...
        if (not validate_onewire_device_path(self.onewire_device_path)):
